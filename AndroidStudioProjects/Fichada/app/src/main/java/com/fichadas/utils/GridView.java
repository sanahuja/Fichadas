...
/**
 * Componente de GridView con posibilidad de aadir un header mediante
...
public class GridView extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
    ...
    /**
     * Nos indica si la cabecera se pinta por delante o por detrs del scroll de la lista
     * @return boolean
     */
    ...
    /**
     * Define si la cabecera se pinta por delante del scroll o si el scroll va por encima y la cabecera est fija
    ...
    private void drawHeaders()
    {
        if ( mHeaderViewInfo != null )
        {
            ...
            //Para evitar ciclos infinitos de onDraw / drawHeaders porque si en onDraw le pongo el topMargin efecta
            //repintado, entonces llama a drawHeaders y as....
